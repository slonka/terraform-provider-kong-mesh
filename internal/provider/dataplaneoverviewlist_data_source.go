...
var _ datasource.DataSource = &DataplaneOverviewListDataSource{}
var _ datasource.DataSourceWithConfigure = &DataplaneOverviewListDataSource{}

func NewDataplaneOverviewListDataSource() datasource.DataSource {
	return &DataplaneOverviewListDataSource{}
}

// DataplaneOverviewListDataSource is the data source implementation.
type DataplaneOverviewListDataSource struct {
	client *sdk.KongMesh
}

// DataplaneOverviewListDataSourceModel describes the data model.
type DataplaneOverviewListDataSourceModel struct {
	Items []tfTypes.DataplaneOverviewWithMeta `tfsdk:"items"`
...
func (r *DataplaneOverviewListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_dataplane_overview_list"
}

// Schema defines the schema for the data source.
func (r *DataplaneOverviewListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "DataplaneOverviewList DataSource",
...
func (r *DataplaneOverviewListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *DataplaneOverviewListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *DataplaneOverviewListDataSourceModel
	...
	request, requestDiags := data.ToOperationsGetDataplaneOverviewListRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.GetDataplaneOverviewList(ctx, *request)
	if err != nil {
	...
	if !(res.GetDataplaneOverviewListResponse != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedGetDataplaneOverviewListResponse(ctx, res.GetDataplaneOverviewListResponse)...)
