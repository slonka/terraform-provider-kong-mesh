...
// Generated from OpenAPI doc version 2.0.0 and generator version 2.730.0
...
func New(opts ...SDKOption) *KongMesh {
	sdk := &KongMesh{
		SDKVersion: "0.5.4",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.5.4 2.730.0 2.0.0 github.com/kong/terraform-provider-kong-mesh/internal/sdk",
